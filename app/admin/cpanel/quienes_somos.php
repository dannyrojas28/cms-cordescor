...
$true  = "";
    ...
    $text  = $ctrSelec->GetNosotros('Quienes Somos');
  	if(!empty($_POST['text'])){
	   
      $text = $_POST['text'];
      if($ctrUpdat->updNosotros($text,'Quienes Somos')){
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form id="demo-form" data-parsley-validate action="quienes_somos.php" method="post">
